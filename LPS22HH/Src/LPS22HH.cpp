...
float LPS22HH::getPressure(){
    ...
    return static_cast<float>(pressureData) / LPS22HH::pressureSensitivity;
}
...
float LPS22HH::getTemperature(){
    ...
    return static_cast<float>(temperatureData) / LPS22HH::temperatureSensitivity;
}
